...
function animation_html(F, W; label="", tag="B", speed=0.25)
    ...
    mini_panel(io, PX, PT+2PH+2PGAP, PW, PH, ts, [(Wp, "#2a9d3f", "positive", "4 3"), (Wm, "#d1495b", "negative", "4 3"), (Wn, "#202020", "net", "")], T;
        title="cumulative leg work (= ΔE within phases; impacts excluded)", yticks=nice(minimum(Wm), maximum(Wp)), vlines=tbs, cursor_id="$tag-cur3")
